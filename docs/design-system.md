...
1.  **Modern Swiss Design**: The interface emphasizes cleanliness, readability, and objectivity. It uses strong grid systems, asymmetric layouts, and sans-serif typography (Inter/Geist) to achieve a "International Typographic Style" aesthetic.
...
3.  **Interaction Engineered Motion**: Motion is used to convey physics and weight. Animations should be synchronized (e.g., via Framer Motion) to feel responsive and grounded, not decorative.
