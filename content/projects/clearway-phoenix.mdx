export const metadata = {
	...
	subtitle:
		"The original matching workflow broke in live advising calls. I rebuilt it into three connected systems: a normalized schema, a resumable AI import pipeline, and an explainable matching engine advisors could trust during real student calls.",
	date: "2025-06-08",
...
<Image
  src="/images/clearway-phoenix/phase-1/01-programs-table.png"
  alt="Programs table backed by the normalized program schema."
  priority={true}
/>
...
<Image
  src="/images/clearway-phoenix/phase-2/p2-archive-dashboard-hero.png"
  alt="Completed ETL dashboard with stage rail, reliability panels, and final cost."
/>
...
<Image
  src="/images/clearway-phoenix/phase-3/p3-02-match-score-positive-breakdown.png"
  alt="Positive score breakdown with explainable reasoning per factor."
/>
...
<Gallery
	...
	caption="The complete surface: schema, ETL, and matching across all three phases."
/>