	...
	coverMedia: [
		{
			...
			caption:
				"Phase 3 demo: semantic search, explainable match scoring, and the assignment workflow used by advisors.",
			duration: "1:40",
			metadata: {
				video_title:
		...
		},
		{
			...
			alt: "Phoenix Phase 1 programs table",
		},
		{
			kind: "image",
			src: "/images/clearway-phoenix/phase-2/p2-archive-dashboard-hero.png",
			alt: "Phoenix Phase 2 ETL archive dashboard hero",
		},
		{
			kind: "image",
