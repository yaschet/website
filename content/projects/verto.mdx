export const metadata = {
	title: "Verto",
	description:
		"Architecture of a proprietary AI-powered translation engine designed for high-volume document pipelines.",
	date: "2026-01-26",
	role: "Lead Software Engineer (End-to-End)",
	stack: [
	...
	coverMedia: [
		{
			...
			poster: "/images/verto/review-editor.png",
			title: "Verto: Vision-First Translation",
			alt: "Verto demo poster showing the review editor interface",
			caption:
				"Production workflow: From scanned document upload to native Google Docs reconstruction.",
			duration: "1:30",
			metadata: {
		...
		{
			kind: "image",
			src: "/images/verto/new-translation-page.png",
			alt: "Verto new translation workflow",
		},
		{
			kind: "image",
			src: "/images/verto/dashboard-page.png",
			alt: "Verto dashboard page",
		},
		{
			kind: "image",
			src: "/images/verto/translations-page.png",
			alt: "Verto translations page",
		},
		{
			kind: "image",
			src: "/images/verto/translation-details-page.png",
			alt: "Verto translation details page",
		},
		{
			kind: "image",
			src: "/images/verto/landing-page-blur.png",
			alt: "Verto landing page blur treatment",
		},
	],
	tech: [
		"Next.js 16",
	...
	featured: true,
	listed: true,
	status: "Production-Ready / IP Asset",
	sortOrder: 2,
};
