								...
								<div className="space-y-6 text-body-md text-surface-600 dark:text-surface-400">
									<ScrollReveal phase={2} delay={0.05}>
										<p>
											...
											, obsessing over visual hierarchy and Swiss precision.
											In 2021, I realized design wasn&apos;t enough—I wanted
											the power to build, not just mock up.
										</p>
									</ScrollReveal>
								...
								<div className="grid gap-8 sm:grid-cols-2">
									<ScrollReveal phase={2} delay={0.05}>
										<div className="group space-y-2 border border-transparent p-4 transition-all duration-200 hover:border-surface-200 hover:bg-surface-50/50 dark:hover:border-surface-800 dark:hover:bg-surface-900/30">
											...
											<p className="text-sm text-surface-600 dark:text-surface-400">
												I treat code like a contract. If the API fails, the
												UI is a lie. I build systems that fail gracefully
									...
									<ScrollReveal phase={2} delay={0.1}>
										<div className="group space-y-2 border border-transparent p-4 transition-all duration-200 hover:border-surface-200 hover:bg-surface-50/50 dark:hover:border-surface-800 dark:hover:bg-surface-900/30">
											...
											<p className="text-sm text-surface-600 dark:text-surface-400">
												Latency kills trust. I optimize for &quot;perceived
												performance&quot; using optimistic UI, skeletons,
												and edge caching. No one likes waiting.
											</p>
										</div>
									</ScrollReveal>
									<ScrollReveal phase={2} delay={0.15}>
										<div className="group space-y-2 border border-transparent p-4 transition-all duration-200 hover:border-surface-200 hover:bg-surface-50/50 dark:hover:border-surface-800 dark:hover:bg-surface-900/30">
											...
											<p className="text-sm text-surface-600 dark:text-surface-400">
												I don&apos;t build features for fun. I build to move
												the needle. If a feature doesn&apos;t reduce churn
												or increase revenue, I cut it.
											</p>
										</div>
									</ScrollReveal>
									<ScrollReveal phase={2} delay={0.2}>
										<div className="group space-y-2 border border-transparent p-4 transition-all duration-200 hover:border-surface-200 hover:bg-surface-50/50 dark:hover:border-surface-800 dark:hover:bg-surface-900/30">
											...
											<p className="text-sm text-surface-600 dark:text-surface-400">
												I don&apos;t say &quot;it works on my machine.&quot;
												I own the product from the first line of code to the
								...
								<div className="space-y-6 text-body-md text-surface-600 dark:text-surface-400">
									<ScrollReveal phase={2} delay={0.05}>
										<p>
											...
											. Systems change. I use strict typing (TypeScript/Zod)
											and atomic design principles so that when the business
											pivots, the code doesn&apos;t break.
										</p>
									</ScrollReveal>
									<ScrollReveal phase={2} delay={0.1}>
										<p>
											Ship early. Ship often. I work in weekly cycles with
											working demos. You see architecture decisions in action,
											not in Figma files. Technical debt gets documented and
											prioritized—not hidden until deployment.
										</p>
									</ScrollReveal>
									<ScrollReveal phase={2} delay={0.15}>
										<p>
											I optimize for long-term outcomes. Fast code that nobody
											can maintain is slow code. Clean abstractions that
											enable the next engineer to ship faster are
