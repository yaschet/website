					...
					<div className="mx-auto max-w-3xl px-6 py-12 sm:px-8">
						...
						<Reveal delay={0.1}>
							<p className="mb-8 max-w-xl text-body-lg text-surface-600 dark:text-surface-400">
								Your vision needs more than just a developer—it needs a partner who
								plays to win. I build systems that scale, experiences that convert,
								and software that defines your brand.
							</p>
						</Reveal>
						<Reveal delay={0.2}>
							<Link
