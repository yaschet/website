                      ...
                      <div className="space-y-4">
                        ...
                        <div className="pl-8 text-sm text-surface-500 dark:text-surface-400">
                          ...
                          <p>
                            ...
                            Full SaaS with Supabase Auth, Stripe integration,
                            and Tiptap-based editor.
                          </p>
                        </div>
                      </div>
                    </ScrollReveal>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="pl-8 text-sm text-surface-500 dark:text-surface-400">
                          <p>
                            ...
                            Match thousands of university programs to student
                          ...
                          <p>
                            ...
                            3-phase system using Meilisearch, OpenAI embeddings,
                            and resumable data pipelines.
                          </p>
                        </div>
                      </div>
                    </ScrollReveal>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="pl-8 text-sm text-surface-500 dark:text-surface-400">
                          <p>
                            ...
                            Replace a complex static form with a high-conversion
                          ...
                          <p>
                            ...
                            Typeform-style portal with OCR scanning and dynamic
                            question logic. Delivered in 6 weeks.
                          </p>
                        </div>
                      </div>
                    </ScrollReveal>
