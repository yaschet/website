...
export function H1({ className, ...props }: ComponentPropsWithoutRef<"h1">) {
	return (
		<h1 className={cn("mb-6 mt-0 text-heading-xl", "text-foreground", className)} {...props} />
	);
}
...
export function HR({ className, ...props }: ComponentPropsWithoutRef<"hr">) {
	return (
		<hr
			className={cn("my-12 border-t border-surface-200 dark:border-surface-800", className)}
			{...props}
		/>
	);
}
