...
export function LocationBadge() {
  ...
  return (
    <motion.div
      ...
      animate={
        isEnabled ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.9 }
      }
