  ...
  return (
    <Sonner
      ...
      toastOptions={{
        ...
        classNames: {
          toast:
            "group-[.toaster]:flex group-[.toaster]:items-center group-[.toaster]:gap-4 group-[.toaster]:px-6 group-[.toaster]:py-4",
          title:
            "group-[.toast]:font-bold group-[.toast]:text-xs group-[.toast]:uppercase group-[.toast]:tracking-[0.1em]",
          description:
          ...
          error:
            "group-[.toaster]:border-destructive/30 group-[.toaster]:bg-destructive-50/50 dark:group-[.toaster]:bg-destructive-950/20",
        },
        duration: 4000,
      }}
      {...props}
