...
function ToggleGroup({
  ...
  return (
    <ToggleGroupPrimitive
      className={cn(
        "group/toggle-group bg-surface-100 dark:bg-surface-900 flex w-fit items-center gap-0.5 rounded-xl p-0.5",
        "data-[variant=outline]:border-surface-200 dark:data-[variant=outline]:border-surface-800 data-[variant=outline]:border data-[variant=outline]:shadow-xs",
        className
      )}
      data-size={size}
  ...
  return (
    <ToggleGroupItemPrimitive
      className={cn(
        ...
        "focus-visible:outline-primary-500 focus-visible:outline-2 focus-visible:outline-offset-0",
