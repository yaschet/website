...
const checkboxVariants = cva(
	[
		"peer flex shrink-0 items-center justify-center outline-none",
		...
		variants: {
			variant: {
				default: [
					...
					"data-[state=checked]:border-surface-950 data-[state=checked]:bg-surface-950",
					"data-[state=checked]:text-surface-50",
					"data-[state=indeterminate]:border-surface-950 data-[state=indeterminate]:bg-surface-950",
					"data-[state=indeterminate]:text-surface-50",
					"dark:data-[state=checked]:border-surface-50 dark:data-[state=checked]:bg-surface-50",
					"dark:data-[state=checked]:text-surface-950",
					"dark:data-[state=indeterminate]:border-surface-50 dark:data-[state=indeterminate]:bg-surface-50",
				...
				info: [
					"border border-info/30 bg-background",
				...
				success: [
					"border border-success/30 bg-background",
				...
				warning: [
					"border border-warning/30 bg-background",
