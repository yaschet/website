...
export function HoverTooltip({ visible, children, className, offset }: HoverTooltipProps) {
	return (
		<AnimatePresence>
			{visible && (
				<motion.div
					...
					className={cn(
						"pointer-events-none absolute bottom-full left-1/2 z-30 -translate-x-1/2 whitespace-nowrap",
