...
>(({ children, className, onClose, show = true, variant, withCloseButton = true, ...props }, ref) => {
    ...
    return (
        <AnimatePresence mode="wait">
            {show && (
                ...
                >
                    {/* Alert Icon */}
                    {alertIcon && <div className="mb-4 flex items-center justify-center">{alertIcon}</div>}
                    {/* Content Container */}
