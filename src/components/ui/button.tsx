...
const buttonVariants = cva(
	...
	],
	{
		variants: {
			variant: {
				solid: "bg-[var(--btn-bg)] text-[var(--btn-fg)] after:bg-gradient-to-br after:from-white/20 after:to-transparent",
				...
				plain: "bg-gradient-to-br bg-transparent from-transparent to-transparent text-[var(--btn-fg-plain)] hover:from-[var(--btn-from-hover)] hover:to-[var(--btn-to-hover)]",
			},
			color: {
				default:
