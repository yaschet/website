	...
	return (
		<div className={cn("relative isolate", className)}>
			<div
				aria-hidden="true"
				className={cn(
					"pointer-events-none absolute -z-10 bg-white opacity-100 dark:bg-surface-900 dark:opacity-95",
					insetClassName,
				)}
				style={{
					WebkitMaskImage:
						"radial-gradient(ellipse at center, black 0%, black 54%, transparent 100%)",
					maskImage:
						"radial-gradient(ellipse at center, black 0%, black 54%, transparent 100%)",
				}}
			/>
	...
	return (
		<>
			...
			>
				...
				>
					<Reveal phase={2}>
						<HeroVignette insetClassName="-inset-x-[20px] -inset-y-[16px]">
							<h2
					...
					<Reveal phase={2} delay={0.05}>
						<HeroVignette insetClassName="-inset-x-[18px] -inset-y-[14px]">
							<p
			...
			>
				<div style={{ gridRow: `${HERO_HEAD_START_ROW} / span 6` }}>
					<Reveal phase={2}>
						<HeroVignette
							...
							insetClassName="-inset-x-[26px] -inset-y-[18px]"
						>
							<h2
								className={cn(
				...
				<div style={{ gridRow: `${HERO_BODY_START_ROW} / span 6` }}>
					<Reveal phase={2} delay={0.05}>
						<HeroVignette
							className="inline-block"
							insetClassName="-inset-x-[22px] -inset-y-[16px]"
						>
							<p
								className={cn(
				...
				<div style={{ gridRow: `${HERO_CTA_START_ROW} / span 4` }}>
					<Reveal phase={2} delay={0.1} className="h-full">
						<HeroVignette
							...
							insetClassName="-inset-x-[20px] -inset-y-[16px]"
						>
							<div
